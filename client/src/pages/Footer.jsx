...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full px-6 sm:px-10 lg:px-20 py-16 overflow-hidden ">
      ...
      >
        <div className="flex flex-col justify-between">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-lg sm:text-2xl font-semibold tracking-tight text-black/50">
          ...
          <div className="flex gap-4 mt-6">
            ...
            >
              <FaXTwitter className="w-5 h-5 text-black group-hover:text-black" />
            </a>
            <a
      ...
      <div className="relative z-10 text-center text-black/40 text-sm mt-10 tracking-wide">
        © {new Date().getFullYear()} Sky Renewable Energies. All rights reserved.

        <div className="mt-2 text-black/50 text-xs">
          Designed & Developed by{" "}
          <span className="text-black/50 font-medium hover:text-white transition">
            RV Studios
          </span>
        </div>
      </div>
